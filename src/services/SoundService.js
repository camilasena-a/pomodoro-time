...
export class SoundService {
    static init() {
        try {
            ...
            Logger.warn('Web Audio API não disponível:', e);
        }
    }
    ...
    static playCompleteSound() {
        ...
        try {
            ...
            Logger.warn('Erro ao reproduzir som:', e);
        }
    }
...
SoundService.audioContext = null;
SoundService.enabled = true;
SoundService.volume = 0.3;
SoundService.soundType = 'default';
